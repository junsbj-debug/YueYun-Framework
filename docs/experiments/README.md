...
- continuity validation processes

Experiments are prioritized over theoretical speculation.
...
- identity stability
- long-term interaction adaptation
...
The project does not assume a fixed implementation path.
...
- AI continuity scoring
- local-first collaboration systems
...
- How should offline synchronization work?
- How can experiments remain reproducible?
- How should continuity benchmarks be defined?
