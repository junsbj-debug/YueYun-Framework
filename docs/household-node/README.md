...
- devices should coordinate through local structures
- AI continuity should not fully depend on centralized platforms

The household is treated as the smallest stable long-term unit for AI continuity.
...
- simple operation for ordinary households
...
The node should avoid unnecessary dependency on centralized data platforms.
...
- local digital identity continuity
...
- offline-first AI runtime
- local device synchronization
- low-power household AI server
...
- How can multiple devices share continuity?
- How can ordinary users operate the node easily?
- How can the node remain stable for years?
- How should household nodes connect without losing autonomy?
